...
<link href="<c:url value='resources/css/popup-box.css'/>/>" rel="stylesheet" type="text/css" media="all" />
...
<div class="main">
		...
		<h1>Product Pricing Plans Widget</h1>
...
<!-- 						<li>porro sint occaecat</li> -->
<!-- 						<li>fugiat nulla parinon</li> -->
<!-- 					</ul> -->
				</div>
<%-- 				 </c:forEach> --%>
<%-- 				 </c:if>   --%>
